...
Generates real renderable hero images and formats economic articles safely.
"""
...
def format_economics_markdown(title: str, intro: str, body: Any, conclusion: str) -> str:
    """Formats economic article sections into clean Markdown safely handling lists of dicts or strings."""
    formatted_body = []
